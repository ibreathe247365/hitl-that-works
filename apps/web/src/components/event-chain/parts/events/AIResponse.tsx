	...
	return (
		<div className="space-y-3">
			<div className="rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800/30 dark:bg-green-950/20">
				<p className="text-sm leading-relaxed">{(event.data as any).message || (event.data as any).text}</p>
			</div>
...
export function AIResponseStep({ event }: { event: Event }): ReactElement {
	return (
		<ChainOfThoughtStep label="AI Response" description="Assistant response generated" status="complete">
