...
export function CalculateIntentContent({ event }: { event: Event }): ReactElement {
...
export function DoneForNowIntentContent({ event }: { event: Event }): ReactElement {
    const data = (event.data as any) ?? {};
    return (
...
export function NothingToDoIntentContent({ event }: { event: Event }): ReactElement {
    const data = (event.data as any) ?? {};
    return (
        <div className="space-y-2">
            <div className="flex items-center gap-2">
...
export function DoneForNowIntentStep({ event }: { event: Event }): ReactElement {
    return (
...
export function NothingToDoIntentStep({ event }: { event: Event }): ReactElement {
    return (
