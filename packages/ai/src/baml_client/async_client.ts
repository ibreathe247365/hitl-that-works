          ...
          const env: Record<string, string> = Object.fromEntries(
            ...
            __baml_options__?: BamlCallOptions<never>
              ...
              const env: Record<string, string> = Object.fromEntries(
                ...
                return new BamlStream<partial_types.ClarificationRequest | partial_types.DoneForNow | partial_types.IntentCalculate | partial_types.NothingToDo | partial_types.Await, types.ClarificationRequest | types.DoneForNow | types.IntentCalculate | types.NothingToDo | types.Await>(
                  raw,
                  (a): partial_types.ClarificationRequest | partial_types.DoneForNow | partial_types.IntentCalculate | partial_types.NothingToDo | partial_types.Await => a,
                  (a): types.ClarificationRequest | types.DoneForNow | types.IntentCalculate | types.NothingToDo | types.Await => a,
                  this.ctxManager.cloneContext(),
                  options.signal,
                  )
                  } catch (error) {
