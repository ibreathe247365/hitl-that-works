...
class BamlStreamClient {
	...
	DetermineNextStep(
		...
		| partial_types.Await
		| partial_types.IntentCreateTicket
		| partial_types.IntentSearchGitHub
		| partial_types.IntentUpdateGitHubIssue
		| partial_types.IntentCommentOnIssue
		| partial_types.IntentLinkIssues,
		| types.ClarificationRequest
		| types.DoneForNow
		| types.NothingToDo
		| types.Await
		...
		try {
			...
			>(
				...
				(
					...
					| partial_types.IntentUpdateGitHubIssue
					| partial_types.IntentCommentOnIssue
					| partial_types.IntentLinkIssues => a,
				(
					a,
				):
					| types.ClarificationRequest
