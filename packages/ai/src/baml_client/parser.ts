  ...
  DetermineNextStep(
    ...
    try {
      ...
      return this.runtime.parseLlmResponse(
        ...
        env,
      ) as types.ClarificationRequest | types.DoneForNow | types.IntentCalculate | types.NothingToDo | types.Await
    } catch (error) {
...
export class LlmStreamParser {
  ...
  DetermineNextStep(
      llmResponse: string,
      __baml_options__?: { tb?: TypeBuilder, clientRegistry?: ClientRegistry, env?: Record<string, string | undefined> }
  ): partial_types.ClarificationRequest | partial_types.DoneForNow | partial_types.IntentCalculate | partial_types.NothingToDo | partial_types.Await {
    try {
      const rawEnv = __baml_options__?.env ? { ...process.env, ...__baml_options__.env } : { ...process.env };
      const env: Record<string, string> = Object.fromEntries(
        Object.entries(rawEnv).filter(([_, value]) => value !== undefined) as [string, string][]
      ...
      return this.runtime.parseLlmResponse(
        ...
        __baml_options__?.clientRegistry,
        env,
      ) as partial_types.ClarificationRequest | partial_types.DoneForNow | partial_types.IntentCalculate | partial_types.NothingToDo | partial_types.Await
    } catch (error) {
      throw toBamlError(error);
    }
  }
