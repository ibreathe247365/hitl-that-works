...
export default class TypeBuilder {
    ...
    Calculation: ClassViewer<'Calculation', "operation" | "operands" | "result" | "expression">;
    ...
    constructor() {
        this.tb = new _TypeBuilder({
          classes: new Set([
            "Await","Calculation","ClarificationRequest","DoneForNow","IntentCalculate","NothingToDo",
          ]),
          enums: new Set([
